...
Fvector CObject::Center					()				const	{ VERIFY2(renderable.visual,*cName()); Fvector buffer; renderable.xform.transform_tiny(buffer,renderable.visual->getVisData().sphere.P); return buffer;	}
