...
{
	m_custom_text = pSettings->read_if_exists<LPCSTR>(section,"item_custom_text",nullptr);
	...
	m_custom_mark_texture = pSettings->read_if_exists<LPCSTR>(section,"item_custom_mark_texture",nullptr);
