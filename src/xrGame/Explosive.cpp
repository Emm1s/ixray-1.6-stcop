...
#ifdef DEBUG
		float l_S=effective_volume*(std::abs(l_dir.dotproduct(obj_xform.i))/l_d.x+ std::abs(l_dir.dotproduct(obj_xform.j))/l_d.y+ std::abs(l_dir.dotproduct(obj_xform.k))/l_d.z);
