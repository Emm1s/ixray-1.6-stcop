...
void CFlamethrower::UpdateCL()
{
	...
	if (m_pFlameTraceParticles)
	{
		...
		m_pFlameTraceParticles->SpatialComponent->spatial.sphere.P = pos.c;
...
void CFlamethrower::OnAnimationEnd(u8 state)
{
	...
	case eHiding:	SwitchState(eHidden, false);   break;	// End of Hide
	case eShowing:	SwitchState(eIdle, false);		break;	// End of Show
