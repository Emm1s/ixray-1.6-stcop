...
{
	if (ALife::eHitTypeExplosion == pHDS->hit_type && m_grenade_detonation_threshold_hit < pHDS->damage() && CExplosive::Initiator() == ALife::INVALID_OBJECT_ID || CheckGrenadeExplosionByHit(pHDS))
	{
