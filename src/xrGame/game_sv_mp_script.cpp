...
//	DEFINE_LUA_WRAPPER_METHOD_V1(OnDelayedRoundEnd, ERoundEnd_Result)
	...
	{return ptr->self_type::inherited::createPlayerState(nullptr);}
...
void game_sv_mp_script::script_register(lua_State *L)
{
	...
	[
		class_< game_sv_mp_script, WrapType, game_sv_mp >("game_sv_mp_script")
			.def(	constructor<>())
			.def("GetTeamData",			&game_sv_mp::GetTeamData)
			.def("SpawnPlayer",			&game_sv_mp::SpawnPlayer)
			.def("switch_Phase",		&game_sv_mp::switch_Phase)
