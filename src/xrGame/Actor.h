...
public:
	...
	CPhraseDialogManager*		cast_phrase_dialog_manager	() override					{return this;}
...
public:
	xr_vector<xr_string>		GetKnownPortions() const override;
	xr_vector<xr_string>		GetKnownPortionDialogs(shared_str id) const override;
	xr_vector<xr_string>		GetKnownPortionDisable(shared_str id) const override;
	xr_vector<xr_string>		GetKnownPortionArticles(shared_str id) const override;
	xr_vector<xr_string>		GetKnownPortionArticlesDisable(shared_str id) const override;
	xr_vector<xr_string>		GetKnownPortionTasks(shared_str id) const override;
