...
//			.def_readonly("view",			&CRenderDeviceData::mView)
//			.def_readonly("projection",		&CRenderDeviceData::mProject)
//			.def_readonly("full_transform",	&CRenderDeviceData::mFullTransform)
