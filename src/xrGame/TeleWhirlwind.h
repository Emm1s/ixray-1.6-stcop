...
virtual	CTelekineticObject*		activate				(CPhysicsShellHolder *obj, float strength, float height, u32 max_time_keep, bool rot = true, CTelekineticObject* owner = nullptr);
virtual void					clear					()										;
