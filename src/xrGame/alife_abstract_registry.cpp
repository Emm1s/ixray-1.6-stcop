...
namespace SaveSystemDefined {
	...
	template<>
	void Serialize2<u16, KNOWN_INFO_CONTAINER>(ISaveObject& Object, std::pair<u16, KNOWN_INFO_CONTAINER>& Value)
	{
	...
	template<>
	void Serialize<u16, KNOWN_INFO_CONTAINER>(ISaveObject& Object, xr_map<u16, KNOWN_INFO_CONTAINER>& Value)
	{
		((CSaveObject&)Object).Serialize(Value, fastdelegate::MakeDelegate(&SaveSystemDefined::Serialize2<u16, KNOWN_INFO_CONTAINER>));
	}
